...
const Showtimes = () => {
  ...
  useEffect(() => {
    const fetchInitData = async () => {
      try {
        const res = await axios.get('https://movie-explorer-be.onrender.com/api/admin/showtimes/init-data');
  ...
  const fetchShowtimes = async () => {
    ...
    try {
      const res = await axios.get(`https://movie-explorer-be.onrender.com/api/admin/showtimes/list?cinemaId=${selectedCinema}&date=${selectedDate}`);
  ...
  const getSafePosterUrl = (m: any) => {
    ...
    if (strPath.startsWith('/uploads') || strPath.startsWith('/public')) return `https://movie-explorer-be.onrender.com${strPath}`;
  ...
  const handleSaveShowtime = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (editingShowtimeId) {
        res = await axios.put(`https://movie-explorer-be.onrender.com/api/admin/showtimes/${editingShowtimeId}`, payload);
      } else {
        res = await axios.post('https://movie-explorer-be.onrender.com/api/admin/showtimes', payload);
      }
  ...
  const handleDeleteShowtime = async () => {
    ...
    Swal.fire({
      ...
      if (result.isConfirmed) {
        try {
          const res = await axios.delete(`https://movie-explorer-be.onrender.com/api/admin/showtimes/${editingShowtimeId}`);
